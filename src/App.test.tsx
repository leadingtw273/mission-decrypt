...
const sampleAsset: MissionAssetV1 = {
  ...
  fields: {
    classification: { iv: 'iv00', ciphertext: 'ClassificationCipher01234_-Class', charCount: 12 },
    codename: { iv: 'iv00', ciphertext: 'ClassificationCipher01234_-Class', charCount: 12 },
    difficulty: { iv: 'iv00', ciphertext: 'ClassificationCipher01234_-Class', charCount: 12 },
