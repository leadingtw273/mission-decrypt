    ...
    >
      ...
      <div className="relative z-10 flex min-h-[26rem] flex-col items-center justify-center gap-8">
        ...
        <div className="flex flex-col items-center gap-3 text-center">
          <motion.span
            animate={{ width: `${TYPEWRITER_TEXT.length}ch`, opacity: 1 }}
            className="font-display inline-block overflow-hidden whitespace-nowrap text-2xl text-primary md:text-3xl"
            initial={{ width: '0ch', opacity: 0.65 }}
            transition={{ duration: 1.2, ease: 'linear', repeat: Number.POSITIVE_INFINITY, repeatDelay: 0.35 }}
          >
            {TYPEWRITER_TEXT}
          </motion.span>
